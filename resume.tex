...
\begin{center}
  {\LARGE \textbf{Yuchen Zhang} --- Senior Front-End CAD Engineer} \\
...
\begin{compactdesc}
    ...
    % \item[Languages \& Tools] Python (advanced), C++, Perl, Bash, SystemVerilog, TCL/Tk, SQL  
    % \item[Development \& Infrastructure] Git, CI/CD, Jenkins, GNUMake, Linux, ClearCase, MySQL, PostgreSQL, SQLite, SDLC
    % \item[EDA \& CAD Systems] Front-End CAD, RTL Verification Automation, QA Tool Development, SoC Flow Integration  
    % \item[AI \& Data Tools (project/academic)] LangChain, LangGraph, Streamlit, PyTorch, Pandas, scikit-learn, NLP  
    % \item[Soft Skills] Cross-Functional Collaboration, Technical Communication, Project Ownership, Mentoring
    \item[Languages \& Tools] Python (advanced), C++, Perl, Bash, SystemVerilog, TCL/Tk, SQL
    \item[Dev \& Infra] Git, CI/CD, Jenkins, GNUMake, Linux, ClearCase, SDLC, MySQL/PostgreSQL/SQLite
    \item[EDA \& CAD] Front-End CAD, RTL Verification Automation, QA Tool Development, SoC Flow Integration
    \item[AI \& Data] LangChain, LangGraph, Streamlit, PyTorch, Pandas, scikit-learn, NLP
    \item[Soft Skills] Cross-Functional Collaboration, Technical Communication, Project Ownership, Mentoring
...
\hrule
\medskip
\subsection*{Qualcomm Technologies, Inc., CA \hfill July 2022--Present}

\textbf{Senior Front-End CAD Engineer} \hfill November 2024--Present
\begin{asparaitem}
    \item Owned development of an AI-powered documentation assistant chatbot leveraging Qualcomm’s in-house language model using LangChain, LangGraph, and Streamlit; improved design spec search efficiency across SoC teams.
    \item Scaled and maintained a front-end production-ready automation tool used by up to 100+ RTL designers daily, streamlining verification workflows and reducing manual debugging effort.
    \item Led feature updates, bug resolution, and cross-team support, ensuring reliability across multiple SoC projects.
    \item Integrated automated front-end verification workflows across teams, improving design turnaround efficiency and supporting tapeout readiness.
\end{asparaitem}

\textbf{CAD Software Engineer} \hfill July 2022--November 2024
\begin{asparaitem}
    \item Re-architected legacy Perl QA tool into a modular Python OOP framework, reducing runtime by 50\% and enabling daily RTL verification for 300+ designers.
    \item Developed internal SystemVerilog auto-generation tool, improving code accuracy and reducing manual effort across SoC teams.
    \item Standardized SDLC contribution workflow, enhancing maintainability and onboarding efficiency.
\end{asparaitem}
...
% \begin{asparaitem}
%     % \item Owned the development of an AI-powered documentation assistant chatbot leveraging Qualcomm’s in-house language model.
...
%     % \item Owned and scaled a front-end QA automation tool used by 100+ RTL designers, achieving 10K+ interactions within 5 months, streamlining RTL verification workflow.
...
%     % \item Drove cross-functional integration of automated front-end verification workflows, improving team-wide design turn-around time.
%     \item Owned development of an AI-powered documentation assistant chatbot leveraging Qualcomm’s in-house language model, using LangChain, LangGraph, and Streamlit; improved design spec search efficiency across SoC teams.

%     % \item Owned development of an AI-powered documentation assistant chatbot leveraging Qualcomm’s in-house language model, using LangChain, LangGraph, and Streamlit to enhance design spec search across SoC teams.
%     \item Scaled and maintained a front-end QA automation tool used by 100+ RTL designers, streamlining verification workflows and reducing manual debugging effort.
%     \item Led feature updates, bug resolution, and cross-team support, ensuring tool reliability and consistency across multiple SoC projects.
%     \item Integrated automated front-end verification workflows across teams, improving design turnaround efficiency and supporting tapeout readiness.
% \end{asparaitem}
...
%     % \item Re-architected legacy Perl QA tool into a modular Python OOP framework, reducing runtime by 50\% and enabling daily RTL verification tasks for 300+ designers.
...
%     \item Re-architected legacy Perl QA tool into a modular Python OOP framework, reducing runtime by 50\% and enabling daily RTL verification for 300+ designers.
%     \item Developed internal SystemVerilog auto-generation tool, improving code accuracy and reducing manual effort across SoC teams.
%     \item Standardized SDLC contribution workflow, enhancing code maintainability and onboarding speed for team members.
% \end{asparaitem}
...
%     \item Generated LDA topic modeling models for exploring topics across states
    ...
    \item Conducted data preprocessing, analysis, and visualization on clinical psychology utterance datasets.
    \item Processed 200+ GB of audio files for conversation segmentation using ELAN\@.
    \item Fine-tuned unsupervised Multinomial HMM models for transcript code prediction with confidence scoring.
    \item Developed supervised RNN and LSTM models for utterance state prediction.
    \item Built LDA topic models to explore key discussion topics across different states.
\end{asparaitem}
% %\vspace{0.1in}
...
\begin{asparaitem}
    ...
    \item Co-authored research on neural text generation (arXiv:2112.01660), investigating pre/post-processing effects on summarization accuracy.
...
%     % \item Received Best Project and Data Science Sharing awards in DataFest Fall 2020.
    \item Published research on linguistic cues of “creepiness” (arXiv:2211.05369); developed deep learning models achieving up to 96\% accuracy.
    \item Awarded Best Project Achievement and Best Data Science Sharing awards at DataFest Fall 2020 for a team of six.
