...
\vspace{0.05in}
\begin{compactdesc}
	\item[Topics] NLP, Machine Learning, Data Mining, Recommendation Systems, Data Processing
    \item[Programming Languages] 3+ years of experience: Python, Basic knowledge: R, C++, Bash, etc.
    \item[Database Management] SQLite, MySQL, MongoDB, Amazon DynamoDB, Firebase, Hadoop HDFS
    \item[Tools] PyTorch, TensorFlow, scikit-learn, GitHub, Pandas, Apache Spark RDD, Distributed Systems, Algorithms, etc.
\end{compactdesc}
